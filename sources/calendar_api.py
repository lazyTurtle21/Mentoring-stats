...
def get_calendars_list(service, page_token=None) -> list:
    """Query all calendars"""
    calendars = []
    while True:
...
def get_all_events(service, calendar_id='primary', date_from=None, date_to=None, order_by='startTime') -> list:
    """Query all events from specified calendar within date range"""
    all_events = []
    page_token = None
    while True:
